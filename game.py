...
def normalise_input(user_input):
    ...
    normalised_input = remove_spaces(user_input).lower()
...
def exit_leads_to(exits, direction):
    ...
    #direction = east -> rooms[east] -> name of 'rooms[east]'
...
def print_menu(exits):
    ...
    for direction in exits:
        print(f"Go {direction.upper()} to {rooms[exits[direction]]['name']}.")
...
def menu(exits):
    ...
    while True:
        ...
        if is_valid_exit(exits, normalised_input):
            ...
            print("Invalid choice, please choose another exit.")
